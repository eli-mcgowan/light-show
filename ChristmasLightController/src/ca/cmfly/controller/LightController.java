...
//			sand.lightsOffWithDelay(10);
			...
			// command, #commands, string, bulb, color, r, g, b, intensity
			{
				...
				// command, #commands, string, bulb, color, r, g, b, intensity
				byte[] message = {1,25,
						13,0,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,1,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,2,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,3,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,4,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,5,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,6,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,7,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,8,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,9,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,10,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,11,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,12,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,13,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,14,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,15,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,16,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,17,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,18,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,19,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,20,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,21,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,22,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,23,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,24,(byte) color,0,0,0,(byte) MAX_INTENSITY};
				...
				byte[] message2 = {1,50,
						...
						13,23,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,24,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,25,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,26,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,27,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,28,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,29,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,30,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,31,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,32,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,33,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,34,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,35,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,36,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,37,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,38,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,39,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,40,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,41,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,42,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,43,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,44,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,45,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,46,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,47,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,48,(byte) color,0,0,0,(byte) MAX_INTENSITY,
						13,49,(byte) color,0,0,0,(byte) MAX_INTENSITY
						};
